        ...
        <div className="col-span-8 max-lg:col-span-7">
          ...
          <div>
            <div className="pt-4 pb-8 px-6 max-sm:px-3 flex flex-col gap-3">
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <select
                    ...
                    className="dark:text-gray-200 dark:bg-gray-800 border-gray-300 rounded-md focus:border-gray-500 ring-white px-3 text-gray-800 py-0.5 border"
                  >
              ...
              <div className="max-sm:overflow-x-scroll h-[355px] max-sm:h-[346px] scroll">
