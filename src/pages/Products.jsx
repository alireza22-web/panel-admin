            ...
            <div className="pt-4 pb-8 px-6 max-sm:px-3 flex flex-col gap-3">
              {
                ...
                <div className={`${warning ? '' : 'hidden'}  transition-all max-[480px]:px-3 max-[480px]:py-2 duration-200 dark:bg-gray-800 dark:border-gray-800 dark:text-gray-400  flex flex-col gap-0.5 bg-gray-200 text-gray-700 border border-gray-300 rounded-lg px-8 relative py-5 items-start justify-start`}>
                  <div className="flex gap-1 items-center max-[480px]:flex-col">
                    این ایکون   
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} onClick={()=>setWarning(false)} stroke="currentColor" className="cursor-pointer size-4 absolute top-2 right-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  <select
                    ...
                    className="dark:text-gray-200 dark:border-gray-900 dark:bg-gray-800 border-gray-300 rounded-md focus:border-gray-500 dark:focus:border-gray-950 ring-white px-3 text-gray-800 py-0.5 border"
                  >
              ...
              <div className="relative ">
                <input
                  ...
                  value={search}
                  className="bg-gray-200 w-full rounded-lg px-4 py-3 border-none outline-none dark:bg-gray-900"
                />
                <svg
                ...
                <table className="w-full max-sm:text-sm h-fit  max-sm:mx-auto text-right border-b px-4 dark:bg-gray-800">
                  ...
                  <tbody className="">
                    {currentUsers.map((item, i) => {
                      return (
                        <tr
                          className="even:bg-gray-200 even:dark:bg-gray-950"
                          key={i}
                        >
                          <td>
