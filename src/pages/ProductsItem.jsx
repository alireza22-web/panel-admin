          ...
          <div className="min-h-screen">
            <div className="pt-4 max-lg:w-full lg:grid grid-cols-10 max-lg:grid-cols-1 pb-8 px-6 max-sm:px-3 place-items-center gap-4">
              <div className="col-span-7 flex max-lg:flex-col max-lg:text-center gap-2">
                <div className="">
                  <img src={data.image} className="w-80 h-80 max-lg:mx-auto object-cover" alt={data.name} />  
                </div>
              ...
              <div className="lg:col-span-3 max-lg:mx-auto flex flex-col justify-between  rounded-lg bg-gray-200 dark:bg-[#101010] p-4 w-full h-full text-gray-700 dark:text-gray-400">
                ...
                <div className="w-full bg-sky-300 dark:bg-[#080808] rounded-md  px-4 py-3 text-center">
